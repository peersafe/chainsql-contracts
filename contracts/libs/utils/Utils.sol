...
import "./../../../core/cross_chain_manager/interface/IToolsPrecompiled.sol";
...
library Utils {
    ...
    */
    function hashLeaf(bytes memory _data) internal pure returns (bytes32 result)  {
        IToolsPrecompiled tools = IToolsPrecompiled(address(0x1002));
        result = tools.eth_sha256(abi.encodePacked(byte(0x0), _data));
    }
    ...
    */
    function hashChildren(bytes32 _l, bytes32  _r) internal pure returns (bytes32 result)  {
        IToolsPrecompiled tools = IToolsPrecompiled(address(0x1002));
        result = tools.eth_sha256(abi.encodePacked(bytes1(0x01), _l, _r));
    }
